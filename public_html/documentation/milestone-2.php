...
<html lang="en">
	...
	<body>
		...
		<p><em>My one-page site will be a statement piece of svg graphics. A complete svg art piece will serve as both the backgound, and have harmoniously integrated sections for the following(alternatively the svg can be broken down to fit within the framework of Bootstrap to appear as though is a complete art piece):</em></p>
		<div>
		...
		<div>
			<h2>Wireframes:</h2>
			<h3>Mobile Design:</h3>
			<img src="images/wireframe-phone2.svg" alt="wireframe design for mobile phone"/>
			<h3>Desktop:</h3>
